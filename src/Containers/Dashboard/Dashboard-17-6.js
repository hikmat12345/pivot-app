...
getReportdata=async(template="")=>{
    ...
    await API.post('pivot','/getReportdata',{body:{
...
await this.setState({
            ...
            this.activityRecord([
              {
                ...
                "ProjectName": projects.find(project => project.guid === event).Name,
                "ColumnName": "",
                "ValueFrom": "",
                "ValueTo": "'",
                "Tenantid": localStorage.getItem('tenantguid')
  ...
  applyExcludeHandler = async () => {
    let previousValues = "";
    previousValues += this.state.check_zero_rows ? "Zero" : "";
    previousValues += this.state.check_blank_row ? "Blank" : "";
    previousValues += this.state.check_hidden_columns ? "Hidden" : "";
    previousValues += this.state.check_heading_totals ? "Heading" : "";
    ...
    if (this.state.editTemplateModal === '') {
      ...
      await API.post('pivot', '/updatefields', {
        ...
        .then(async (data) => {
          ...
          let dateTime = this.getDateTime();
          let newValues = "";
          newValues += this.state.check_zero_rows ? "Zero" : "";
          newValues += this.state.check_blank_row ? "Blank" : "";
          newValues += this.state.check_hidden_columns ? "Hidden" : "";
          newValues += this.state.check_heading_totals ? "Heading" : "";
        ...
        pivotGroupTagRow.Columns.map(async (cell, cellIndex) => {
          ...
          if (
            ...
            if (periodCount === 0 && column.DoNotCalculate === true) {
              ...
              // console.log(
              //   "applyColumnFormula - Final Result xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx:  ", expression
              // );
              cell.obj.TextValue = this.evaluateExpression(expression);
            }
...
var path = window.location.protocol + '//' + window.location.host + '/reportpdf';
