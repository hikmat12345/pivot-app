...
(function($)
{
    ...
    var TagSuggest = function(element, options)
    {
        ...
        var defaults = {
             ...
             */
            emptyText: function() {
                return cfg.editable ? '' : 'Click here';
            },
...
//    $.fn.tagSuggest.defaults = {};
        ...
        $(document).ready(function() {
            var jsonData = [];
//            var fruits = 'Alarm System, Built-in wardrobes,Floorboards'.split(',');
            var fruits = ["ABS","Front Camera","Power Windows","AM/FM Radio","Air Bags","CD Player","Alloy Rims","Air Conditioning","Cruise Control","Immobilizer Key","Power Mirrors","Power Locks","Sun Roof","Power Windows","Power Steering","Keyless Entry"];
